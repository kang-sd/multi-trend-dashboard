// Google Drive/Sheets 공통 유틸 (Vercel Edge Runtime)
...
// process.env에서 Env 객체 생성 (Vercel Edge Runtime)
export const getEnvFromProcess = (): Env => ({
  GOOGLE_SERVICE_ACCOUNT: process.env.GOOGLE_SERVICE_ACCOUNT ?? '',
  DASHBOARD_SHEET_ID: process.env.DASHBOARD_SHEET_ID,
  DRIVE_FOLDER_ID: process.env.DRIVE_FOLDER_ID,
  DRIVE_FALLBACK_PARENT_ID: process.env.DRIVE_FALLBACK_PARENT_ID,
  DRIVE_TARGET_FOLDER_NAME: process.env.DRIVE_TARGET_FOLDER_NAME,
});
